...
public  class MakeAppointServlet extends HttpServlet
{
    @Override
    ...
    private void setAppoint_table(ItemV2 item){
    	...
    	for(BigDecimal offset:timeZoneID.id_map){
        	...
        	Collection<String> name_set = new HashSet<>();
        	name_set.add((String)doctor.get("email"));
        	value_map.put("doctors",name_set);
